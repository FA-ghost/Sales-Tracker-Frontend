...
function Navbar(){
    ...
    return (
        <nav className="w-full flex justify-end p-[10px] relative">
            <div className="flex gap-[15px] p-[10px] items-center rounded-sm hover:bg-[#4A6CF7] hover:text-white" onClick={updateIsOpen}>
            ...
            <div className={`w-[150px] bg-[#4A6CF7]/80 text-[#F5F6FA] rounded-md absolute top-[70px] right-[30px] ${isOpen ? "block" : "hidden"} `} onMouseLeave={updateIsOpen}>
